...
[Index](../index.md) · [Chapter 18 canon](../chapters/chapter_18.md)

<form class="reader-feedback" data-page-id="Chapter 18 retrospective" onsubmit="return submitReaderFeedback(event)">
  <details>
    <summary>💬 Send anonymous feedback on this page</summary>
    <input type="hidden" name="chapter" value="Chapter 18 retrospective">
    <label>Kind:
      <select name="kind">
