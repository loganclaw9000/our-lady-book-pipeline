...
[Index](../index.md) · [Chapter 1 canon](../chapters/chapter_01.md)

<form class="reader-feedback" data-page-id="Chapter 1 retrospective" onsubmit="return submitReaderFeedback(event)">
  <details>
    <summary>💬 Send anonymous feedback on this page</summary>
    <input type="hidden" name="chapter" value="Chapter 1 retrospective">
    <label>Kind:
      <select name="kind">
